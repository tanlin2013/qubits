...
sys.path.insert(0, os.path.abspath("../../qubits"))
...
version = metadata.version("qubits")
# The full version, including alpha/beta/rc tags
release = metadata.version("qubits")
...
# documentation.
html_theme_options = {
    "github_url": "https://github.com/tanlin2013/qubits",
    "repository_url": "https://github.com/tanlin2013/qubits",
